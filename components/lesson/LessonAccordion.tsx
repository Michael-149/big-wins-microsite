...
export default function LessonAccordion({ sections }: LessonAccordionProps) {
    ...
    <div className="lg:hidden space-y-4">
      {sections.map((section) => {
        ...
        return (
          <div
            key={section.id}
            className="border-2 border-sil-primary/30 rounded-lg overflow-hidden"
          >
            {/* Accordion Header */}
            <button
            ...
            >
              ...
              <svg
                className={`w-6 h-6 text-sil-primary transition-transform ${
                  isOpen ? 'rotate-180' : ''
                }`}
                fill="none"
                viewBox="0 0 24 24"
            ...
            {isOpen && (
              <div
                className="px-6 py-6 bg-white border-t-2 border-sil-primary/10
